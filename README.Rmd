...
Please cite the package with the assocaited paper (https://doi.org/10.1002/mcda.1717). 
...
#Plot the data
The first step to any problem: Visualize the data. This is how we normally see the out put of simulation.
